...
- 知识库会参与检索与引用，详见 [knowledge.md](knowledge.md) 与 [knowledge_integration.md](knowledge_integration.md)。
...
- 在 [knowledge_integration.md](knowledge_integration.md) 中有更细的入库与检索逻辑说明。
...
- [knowledge.md](knowledge.md)：解释如何向知识库写入与检索信息；
- [knowledge_integration.md](knowledge_integration.md)：说明 Research Agent 如何与知识库、CNINFO 工具与 PDF 抽取协同工作；
